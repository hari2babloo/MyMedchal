...
//            Log.d("TAG", eventID);
    ...
    public void onCancelled(@NonNull DatabaseError databaseError) {
        ...
        //
        FirebaseRecyclerOptions personsOptions = new FirebaseRecyclerOptions.Builder<SubCategoryModel>().setQuery(mDatabase.orderByChild("category").equalTo("Shopping"),  SubCategoryModel.class).build();
