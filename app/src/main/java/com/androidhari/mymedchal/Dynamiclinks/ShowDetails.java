package com.androidhari.mymedchal.Dynamiclinks;
...
public class ShowDetails extends AppCompatActivity {
    ...
    private static final String DEEP_LINK_URL = "https://mymedchal.page.link/deeplinks";
    ...
    public Uri buildDeepLink(@NonNull Uri deepLink, int minVersion) {
        String uriPrefix = "https://mymedchal.page.link";
    ...
    private void validateAppCode() {
       // String uriPrefix = getString("https://bablooswedding.page.link");
        if ("https://mymedchal.page.link".contains("YOUR_APP")) {
